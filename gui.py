...
covid = pd.read_csv('dataseti-dataseti.csv')
...
Label(root, text="Impact of Covid-19 in Economy of Kosovo", bg="white",font= "Helvetica 20" ).place(x = 130,y = 50)
...
Button(root, text="Percentage of companies with positive and negative GDP",bg="white",width='50' ,height='1',font="Raleway",command=func3).place(x = 130, y = 300)
Button(root, text="Percentage of sector GDP per country",bg="white",width='50' ,height='1',font="Raleway",command=func4).place(x = 130, y = 350)
Button(root, text="Accuracy Score",bg="white",width='20' ,height='1',font="Raleway",command=func5).place(x = 300, y = 600)
Entry(root, textvariable=teksti1 , bg="white").place(width=600, height=80, x = 130, y = 450)
root.mainloop()